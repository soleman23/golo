...
- **Phase 4 · Betting acceptance**
  ...
  - **Remaining:** an organizer "betting status" entry point from Scoring; re-finalize when bets are edited mid-round.
  - **Status:** 0025 applied; foundation + core UI + payout gate committed on `feat/notifications-inbox` (PR #1).
