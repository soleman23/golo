...
try {
  ...
  check(initialPoolCount <= 5, `initial unified list is capped at five rows (saw ${initialPoolCount})`)
  ...
  if (await pagination.isVisible().catch(() => false)) {
    ...
    console.log('• pagination not shown because five or fewer merged courses are available')
  }
